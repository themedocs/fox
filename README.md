...
Source for <https://themedocs.github.io/fox/> — the documentation for the Fox WordPress theme.
...
```
content/index.md          the fox docs home
content/<section>/<page>.md
docs/assets/              screenshots, referenced as /fox/assets/…
