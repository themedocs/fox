---
title: "FOX Block explained"
description: "This article explains how FOX Block works and how to use it to build header, footer, off-canvas menu as well as any pop-up."
---
...
However, the only purpose of each FOX Block is *to be used in other parts* (like header, footer). It has no purpose for itself. For instance, in [this demo](https://thefox.withemes.com/times3/), the Header is actually a FOX block named “Header”.
...
![](/fox/assets/image.jpg)

List of all FOX Blocks

![](/fox/assets/image-1.jpg)
