---
title: "Header"
description: "The Fox comes with a very intuitive header builder right in Customizer."
---

The Fox comes with a very intuitive header builder right in Customizer.

![](/fox/assets/header-002.png)
...
![](/fox/assets/header-006-header-elements.png)

#### Header Menu

![](/fox/assets/header-007-header-elements.png)

Before that, you need to create a new menu, and check “**Primary Menu**” checkbox in the bottom.

![](/fox/assets/header-009-header-elements-menu.png)

#### Header menu icon

Enter icon name from FontAwesome, you can get here: [https://fontawesome.com/v4/icons/](https://fontawesome.com/v4/icons/)

![](/fox/assets/header-031-header-icon.png)

#### Hamburger

On Front-end, when you click on **Hamburger** button then will show the **off-canvas menu**.

![](/fox/assets/header-014-header-elements-hamburger.png)
...
![](/fox/assets/header-015-header-elements-hamburger-style.png)

Settings content of Off-Canvas

Click **`Customize > Header > Offcanvas`** to edit/custom Off-Canvas.

![](/fox/assets/header-021-header-elements-offcanvas.png)

#### HTML1, HTML2, HTML3

Add your custom content into the HTML elements. Have 3 elements: Html1, Html2, Html3.

![](/fox/assets/header-022-header-elements-html.png)

`**Tips**:` read more [button shortcode here](/fox/miscellaneous/button-shortcode/).

### Mega Menu

![](/fox/assets/header-010-header-elements-mega-menu.png)
...
![](/fox/assets/header-013-header-elements-mega-menu.png)

#### Category Mega Menu

You can also convert a category item into a category mega menu

![](/fox/assets/header-026-header-cat-mega-menu.png)
...
![](/fox/assets/header-023-header-elements-sticky.png)

For mobile, click **`Customize > Header > Header Mobile`**, then click to “**Sticky Header Mobile?**“

![](/fox/assets/header-024-header-elements-sticky-mobile.png)

### Hero Post Header

Being **used for HERO Posts**, for instance, [Hero Full](https://docs.withemes.com/fox/times/im-a-high-school-graduate/) or [Hero Half](https://docs.withemes.com/fox/times/bronx-new-york-in-the-pandemic/). Hero Header contains only logo + hamburger button.

**First**, you must select the layout for the post as either *Hero Full* or *Hero Half*.

![](/fox/assets/header-025-header-elements-sticky-hero-lay.png)

Next, click **`Customize > Header >` Header Hero Post** to edit.

![](/fox/assets/header-025-header-header-hero-post.png)
