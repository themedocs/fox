...
A **single post** determines the layout of your blog posts. It is used to display the post details [like this](https://docs.withemes.com/fox/times/we-got-a-right-to-pick-a-little-fight-bonanza/). *Not blog, category or archive page*.
...
![](/fox/assets/customize-single-post-001.png)

**Local settings area** (*on the edit post page*).

![](/fox/assets/customize-single-post-002.png)
...
![](/fox/assets/customize-single-post-004-7-layouts.png)

**You can view the examples here:**

- [Layout 1](https://docs.withemes.com/fox/classic/travel-post-4/)
- [Layout 1b](https://docs.withemes.com/fox/classic/image-stack-gallery/)
- [Layout 2](https://docs.withemes.com/fox/classic/politics-post-4/)
- [Layout 3](https://docs.withemes.com/fox/classic/photography-post-3/)
- [Layout 4 (Hero Full)](https://docs.withemes.com/fox/times/im-a-high-school-graduate/)
- [Layout 5 (Hero Half)](https://docs.withemes.com/fox/times/bronx-new-york-in-the-pandemic/)
- [Layout 6](https://docs.withemes.com/fox/times/i-went-to-art-school/)
...
![](/fox/assets/customize-single-post-005-post-format.png)

**Video format for post:**

![](/fox/assets/customize-single-post-006-post-format-video.png)

**Gallery format for post:**

![](/fox/assets/customize-single-post-007-post-format-gallery.png)

**Note**: you can display inside post content by using the shortcode `[[fox_gallery]]`.

![](/fox/assets/customize-single-post-008-post-format-gallery-shortcode.png)

### Post Review

Add review integration to any post on your site.

![](/fox/assets/customize-single-post-009-post-review-1024x473-1.png)

Ex: makes it easy to create product comparisons, and much more.

![](/fox/assets/image.png)

Tips: **you can reorder/show/hide** the Review element [view here](/fox/theme-parts/single/#arrange-show-hide).
...
![](/fox/assets/customize-single-post-014-live-post.png)
...
![](/fox/assets/image-5.png)

Custom for **after content**:

![](/fox/assets/image-6.png)
