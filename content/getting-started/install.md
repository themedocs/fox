---
title: "Install"
description: "1. Go to WordPress Dashboard > Appearance > Themes > Add new. For multisite, go to Network admin > Themes > Add new"
---

### Install theme

1. Go to WordPress **Dashboard > Appearance > Themes > Add new**. For multisite, go to **Network admin > Themes > Add new**
...
3. **WooCommerce**: If you don't need a shop or you don't sell anything on your site, don't need to install it.
4. **Instagram feed**: If you don't need instagram feed, don't install it.
5. **Mailchimp For WP**: If you don't need newsletter/subscription form, you don't need to install it. Note that, this is plugin for Mailchimp newsletter.
6. **Polylang**: You don't need this
7. **Elementor**: DO NOT install it, unless you need it. The Fox doesn't require Elementor. Only Fox old version (before 2020) requires it, but now The Fox doesn't.
8. **Fox Framework**: If your site is made from Elementor, you might need it. Otherwise, you don't need this since Fox has been implemented its own builder for years.

### Import demo

Please read [this article](/fox/getting-started/import-demo/)
