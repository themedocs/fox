...
Before importing, visit the **[demo list](https://fox.heronwp.com/demolist/)**, find the demo you want to import, then download 3 required files. **Note**: File names might be different, but you only need to pay attention to file extensions (*dat for customizer, *xml for content, *wie for widgets)
