...
1. **Post format video**: Video will appear at the place of featured image of the post. [View example >>](https://fox.withemes.com/times/ive-always-felt-responsible-for-world-war-ii/)
...
- [Example post with 16/9 ratio](https://fox.withemes.com/example/2024/09/22/video-ratio-16-9/)
- [Example post with 4/3 ratio](https://fox.withemes.com/example/2024/09/22/video-ratio-4-3/)
- [Example Youtube short with 9/16](https://fox.withemes.com/example/2024/09/22/youtube-short-ratio-9-16/). You feel it's quite big, right? That's why we have the 4th option, which is better for the Short videos.
- [Example Youtube short with 16/9 on desktop and 9/16 on mobile](https://fox.withemes.com/example/2024/09/22/youtube-short-with-16-9-on-desktop-and-9-16-on-mobile/). On desktop, you'll see it as a normal video. On mobile, It's fullscreen as short video. Scan QR below to test it on mobile. ![](/fox/assets/qr.png)
